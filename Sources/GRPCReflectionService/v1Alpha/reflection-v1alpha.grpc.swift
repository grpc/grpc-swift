...
internal protocol Grpc_Reflection_V1alpha_ServerReflectionProvider: CallHandlerProvider {
  var interceptors: Grpc_Reflection_V1alpha_ServerReflectionServerInterceptorFactoryProtocol? { get }

  /// The reflection service is structured as a bidirectional stream, ensuring
  /// all related requests go to a single server.
  func serverReflectionInfo(context: StreamingResponseCallContext<Grpc_Reflection_V1alpha_ServerReflectionResponse>) -> EventLoopFuture<(StreamEvent<Grpc_Reflection_V1alpha_ServerReflectionRequest>) -> Void>
}

extension Grpc_Reflection_V1alpha_ServerReflectionProvider {
  internal var serviceName: Substring {
    return Grpc_Reflection_V1alpha_ServerReflectionServerMetadata.serviceDescriptor.fullName[...]
  }
...
extension Grpc_Reflection_V1alpha_ServerReflectionAsyncProvider {
  ...
  internal var interceptors: Grpc_Reflection_V1alpha_ServerReflectionServerInterceptorFactoryProtocol? {
    return nil
  }
...
internal protocol Grpc_Reflection_V1alpha_ServerReflectionServerInterceptorFactoryProtocol: Sendable {

  /// - Returns: Interceptors to use when handling 'serverReflectionInfo'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeServerReflectionInfoInterceptors() -> [ServerInterceptor<Grpc_Reflection_V1alpha_ServerReflectionRequest, Grpc_Reflection_V1alpha_ServerReflectionResponse>]
}

internal enum Grpc_Reflection_V1alpha_ServerReflectionServerMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    name: "ServerReflection",
    fullName: "grpc.reflection.v1alpha.ServerReflection",
    methods: [
      Grpc_Reflection_V1alpha_ServerReflectionServerMetadata.Methods.serverReflectionInfo,
    ]
  )
