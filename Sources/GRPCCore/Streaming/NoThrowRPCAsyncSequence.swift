...
/// A type-erasing, non-throwing `AsyncSequence`.
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
public struct NoThrowRPCAsyncSequence<Element>: AsyncSequence, Sendable {
  private let _makeAsyncIterator: @Sendable () -> AsyncIterator

  /// Creates an ``NoThrowRPCAsyncSequence`` by wrapping another `AsyncSequence`.
...
extension NoThrowRPCAsyncSequence.AsyncIterator: Sendable {}
