...
class EmptyUnary: InteropabilityTest {
...
class CacheableUnary: InteropabilityTest {
  func run(using connection: GRPCClientConnection) throws {
    let client = Grpc_Testing_TestServiceService_NIOClient(connection: connection)
...
class LargeUnary: InteropabilityTest {
  func run(using connection: GRPCClientConnection) throws {
    let client = Grpc_Testing_TestServiceService_NIOClient(connection: connection)
...
class ClientStreaming: InteropabilityTest {
  func run(using connection: GRPCClientConnection) throws {
    let client = Grpc_Testing_TestServiceService_NIOClient(connection: connection)
...
class ServerStreaming: InteropabilityTest {
  func run(using connection: GRPCClientConnection) throws {
    let client = Grpc_Testing_TestServiceService_NIOClient(connection: connection)
...
/// - clients are free to assert that the response payload body contents are zero and
///   comparing the entire response messages against golden responses
class PingPong: InteropabilityTest {
  func run(using connection: GRPCClientConnection) throws {
    let client = Grpc_Testing_TestServiceService_NIOClient(connection: connection)
...
class EmptyStream: InteropabilityTest {
  func run(using connection: GRPCClientConnection) throws {
    let client = Grpc_Testing_TestServiceService_NIOClient(connection: connection)
...
class CustomMetadata: InteropabilityTest {
  func run(using connection: GRPCClientConnection) throws {
    let client = Grpc_Testing_TestServiceService_NIOClient(connection: connection)
...
class StatusCodeAndMessage: InteropabilityTest {
  func run(using connection: GRPCClientConnection) throws {
    let client = Grpc_Testing_TestServiceService_NIOClient(connection: connection)
...
class SpecialStatusMessage: InteropabilityTest {
  func run(using connection: GRPCClientConnection) throws {
    let client = Grpc_Testing_TestServiceService_NIOClient(connection: connection)
...
class UnimplementedMethod: InteropabilityTest {
  func run(using connection: GRPCClientConnection) throws {
    let client = Grpc_Testing_TestServiceService_NIOClient(connection: connection)
...
/// Client asserts:
/// - received status code is 12 (UNIMPLEMENTED)
class UnimplementedService: InteropabilityTest {
  func run(using connection: GRPCClientConnection) throws {
...
class CancelAfterBegin: InteropabilityTest {
  func run(using connection: GRPCClientConnection) throws {
    let client = Grpc_Testing_TestServiceService_NIOClient(connection: connection)
    let call = client.streamingInputCall()
    call.cancel()
...
/// Client asserts:
/// - Call completed with status CANCELLED
class CancelAfterFirstResponse: InteropabilityTest {
  func run(using connection: GRPCClientConnection) throws {
    let client = Grpc_Testing_TestServiceService_NIOClient(connection: connection)
...
class TimeoutOnSleepingServer: InteropabilityTest {
  func run(using connection: GRPCClientConnection) throws {
    let client = Grpc_Testing_TestServiceService_NIOClient(connection: connection)
