...
class Generator {
  ...
  private func printMain() {
    ...
    printer.print("""
      ...
      printer.print("""
      // DO NOT EDIT.
      // Generated by the protocol buffer compiler. proto
      // protoc test.proto --swift_out=. --swiftgrpc_out=Client=false,Server=false:.
      // Source: \(file.name)
      
      //  Copyright © 2019 Quibi. All rights reserved.
      //
      """)
    }
    ...
    if options.generateNIOImplementation {
      moduleNames = [
        ...
        "SwiftGRPCNIO",
        "SwiftProtobuf"]
    } else if options.generateQuibiRPC {
      moduleNames = [
        "Foundation",
        "SwiftProtobuf"]
    } else {
