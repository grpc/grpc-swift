...
open class ClientCallServerStreamingBase<InputType: Message, OutputType: Message>: ClientCallBase {
...
open class ClientCallServerStreamingTestStub<OutputType: Message>: ClientCall {
