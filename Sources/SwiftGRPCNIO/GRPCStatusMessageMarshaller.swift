...
public struct StatusMessageMarshaller {
  ...
  public static let allowedCharacters: CharacterSet = {
    let lower = CharacterSet(charactersIn: Unicode.Scalar(0x20)...Unicode.Scalar(0x24))
    let upper = CharacterSet(charactersIn: Unicode.Scalar(0x26)...Unicode.Scalar(0x7e))
  ...
  public static func marshall(_ message: String) -> String? {
    return message.addingPercentEncoding(withAllowedCharacters: StatusMessageMarshaller.allowedCharacters)
  }
