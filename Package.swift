...
var packageDependencies: [Package.Dependency] = [
  .package(url: "https://github.com/apple/swift-protobuf.git", version: Version(1,0,2)),
  .package(url: "https://github.com/kylef/Commander.git", version: Version(0,8,0)),
  .package(url: "https://github.com/apple/swift-nio-zlib-support.git", version: Version(1,0,0))
]
...
packageDependencies.append(.package(url: "https://github.com/apple/swift-nio-ssl-support.git", version: Version(1,0,0))
#else
