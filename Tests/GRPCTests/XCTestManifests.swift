...
extension GRPCClientStateMachineTests {
    ...
    static let __allTests__GRPCClientStateMachineTests = [
        ...
        ("testReceiveResponseFromClientClosedServerStreaming", testReceiveResponseFromClientClosedServerStreaming),
        ("testReceiveResponseFromClientStreamingServerIdle", testReceiveResponseFromClientStreamingServerIdle),
        ("testReceiveResponseFromClosed", testReceiveResponseFromClosed),
        ("testReceiveResponseFromIdle", testReceiveResponseFromIdle),
        ("testReceiveResponseFromStreaming", testReceiveResponseFromStreaming),
