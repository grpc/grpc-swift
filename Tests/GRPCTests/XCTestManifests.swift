...
extension GRPCRequestInfoTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__GRPCRequestInfoTests = [
        ("testExtractFromInvalidGRPCRequestHead", testExtractFromInvalidGRPCRequestHead),
        ("testExtractFromValidGRPCRequestHead", testExtractFromValidGRPCRequestHead),
    ]
}
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(GRPCRequestInfoTests.__allTests__GRPCRequestInfoTests),
