...
nonisolated struct Normalization_FunctionName: Sendable {
...
fileprivate nonisolated let _protobuf_package = "normalization"

nonisolated extension Normalization_FunctionName: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".FunctionName"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}functionName\0")
