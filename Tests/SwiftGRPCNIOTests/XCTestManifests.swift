...
extension GRPCInsecureInteropabilityTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__GRPCInsecureInteropabilityTests = [
...
extension GRPCSecureInteropabilityTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__GRPCSecureInteropabilityTests = [
        ("testCacheableUnary", testCacheableUnary),
        ("testCancelAfterBegin", testCancelAfterBegin),
        ("testCancelAfterFirstResponse", testCancelAfterFirstResponse),
        ("testClientStreaming", testClientStreaming),
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(GRPCInsecureInteropabilityTests.__allTests__GRPCInsecureInteropabilityTests),
        testCase(GRPCSecureInteropabilityTests.__allTests__GRPCSecureInteropabilityTests),
