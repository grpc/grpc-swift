...
public struct Grpc_Testing_ByteBufferParams {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var reqSize: Int32 = 0

  public var respSize: Int32 = 0
...
public struct Grpc_Testing_SimpleProtoParams {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///              protos are decided
public struct Grpc_Testing_ComplexProtoParams {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Grpc_Testing_PayloadConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var payload: Grpc_Testing_PayloadConfig.OneOf_Payload? = nil

  public var bytebufParams: Grpc_Testing_ByteBufferParams {
    get {
  ...
  public var simpleParams: Grpc_Testing_SimpleProtoParams {
    get {
  ...
  public var complexParams: Grpc_Testing_ComplexProtoParams {
    get {
...
extension Grpc_Testing_ByteBufferParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ByteBufferParams"
  ...
  public static func ==(lhs: Grpc_Testing_ByteBufferParams, rhs: Grpc_Testing_ByteBufferParams) -> Bool {
...
extension Grpc_Testing_SimpleProtoParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SimpleProtoParams"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "req_size"),
    2: .standard(proto: "resp_size"),
  ]
  ...
  public static func ==(lhs: Grpc_Testing_SimpleProtoParams, rhs: Grpc_Testing_SimpleProtoParams) -> Bool {
    if lhs.reqSize != rhs.reqSize {return false}
    if lhs.respSize != rhs.respSize {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Grpc_Testing_ComplexProtoParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ComplexProtoParams"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  public static func ==(lhs: Grpc_Testing_ComplexProtoParams, rhs: Grpc_Testing_ComplexProtoParams) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Grpc_Testing_PayloadConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PayloadConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Grpc_Testing_PayloadConfig, rhs: Grpc_Testing_PayloadConfig) -> Bool {
